// ============================================================
// RULETA - Lógica del juego
// El jugador coloca fichas en las casillas de la mesa y gira la ruleta.
// Se calcula la ganancia según el número y color ganador.
// ============================================================

const BASE = document.body.dataset.base || ''; // URL base del proyecto
localStorage.setItem('fichas', document.body.dataset.fichas || 1000); // fichas iniciales

// Lee las fichas del localStorage
function getFichas() {
...
// Guarda las fichas en el localStorage
...
window.onload = function () {
    ...
    // Colorear las casillas numéricas de la mesa con su color real
    ...
    // Cambiar el valor de la apuesta con la barra deslizante
    barraApuesta.addEventListener("input", () => {
        apuestaActual = parseInt(barraApuesta.value, 10);
        actualizarInfo();
    });

    // Eliminar todas las fichas colocadas y devolverlas al jugador
    ...
    function colocarFichaEnCelda(celda) {
        ...
        // Mostrar o actualizar el número en la ficha visual
    ...
    btnGirar.addEventListener("click", () => {
        ...
        // Girar la imagen de la ruleta (mínimo 4 vueltas + giro aleatorio)
        ...
        setTimeout(() => {
            ...
            for (const apuesta in fichasColocadas) {
                ...
                if (!isNaN(apuesta)) {
                    ...
                    // Apuesta a mitad de números → paga 2x
            ...
            setFichas(fichasDisponibles);
            ultimaApuesta = { ...fichasColocadas }; // guardar para poder repetir
            ...
            actualizarInfo();
        }, 4000); // la animación de la ruleta dura 4 segundos
    });
    ...
    // Repetir la misma apuesta de la ronda anterior
